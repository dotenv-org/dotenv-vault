...
dotenv-vault/0.1.1 darwin-x64 node-v14.17.3
...
_See code: [dist/commands/hello/index.ts](https://github.com/dotenv-org/dotenv-vault/blob/v0.1.1/dist/commands/hello/index.ts)_
